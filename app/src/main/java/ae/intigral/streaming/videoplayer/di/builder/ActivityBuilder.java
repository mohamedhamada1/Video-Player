...
package ae.intigral.streaming.videoplayer.di.builder;


import ae.intigral.streaming.videoplayer.views.player.VideoPlayerActivity;
import ae.intigral.streaming.videoplayer.views.player.VideoPlayerModule;
import dagger.Module;
import dagger.android.ContributesAndroidInjector;

/**
 * should define all class builder
 */
@Module
